...
# <div align="center">Confluent x AWS Data Streaming BUILDER Lab</div>
...
12. [Connect MYSQL sink to Confluent Cloud](#step-12)
...
<div align="center" padding=25px>
    <img src="images/flink_workshop_architecture.png" width=75% height=75%>
</div>
...
- How you can easily activate Confluent Cloud on AWS
- How to connect AWS with Confluent Cloud
...
1. Click **+ Add Environment**. Specify an **Environment Name**, select **Essentials** for Stream Governance Packages and click **Create**. 

>**Note:** There is a *default* environment ready in your account upon account creation. You can use this *default* environment for the purpose of this workshop if you do not wish to create an additional environment.

<div align="center" padding=25px>
    <img src="images/create_env.png" width=50% height=50%>
</div>
...
4. Choose AWS as Cloud Provider and your preferred, region (Singapore/ asia-southeast1) , and Uptime SLA is default. 

<div align="center" padding=25px>
    <img src="images/cluster-region.png" width=50% height=50%>
</div>

5. Specify a **Cluster Name**. For the purpose of this lab, something like **flink_{username}** should work, to be able to easily identify your clusters. 
...
<div align="center" padding=25px>
    <img src="images/create_compute_pool_aws.png" width=50% height=50%>
</div>

3. Name you **Pool Name**. Click **Create**.

<div align="center" padding=25px>
    <img src="images/compute_pool_config.png" width=50% height=50%>
</div>
...
<div align="center" padding=25px>
    <img src="images/compute_pool_running.png" width=50% height=50%>
</div>
...
## <a name="step-4"></a>Create Topic and Walk Through Cloud Dashboard
...
```sql
CREATE TABLE accounts_to_monitor_{username}(
  window_start TIMESTAMP,
  window_end TIMESTAMP,
  account STRING,
  quantity BIGINT,
...
```sql
INSERT INTO accounts_to_monitor_{username}
SELECT window_start,
  window_end,
  account,     
  COUNT(*) AS quantity
...
6. Add Flink Statement windows by click (+). Verify the result.
  ```sql
Select * from  accounts_to_monitor_{username};
``` 
***
...
## <a name="step-12"></a>Connect MYSQL sink to Confluent Cloud

The next step is to sink data from Confluent Cloud into MYSQL RDS using the [fully-managed MYSQL Sink connector](https://docs.confluent.io/cloud/current/connectors/cc-mysql-sink.html). The connector will send real time data on **accounts_to_monitor** into MYSQL Database.

1. From the Confluent Cloud UI, click on the Connectors tab on the navigation menu and select **+Add connector**. Search and click on the MYSQL Sink icon.

<div align="center">
    <img src="images/mysqlsink-1.png" width=30% height=30%>
</div>

2. Select the topic "accounts_to_monitor_{username}"

<div align="center">
    <img src="images/mysqlsink-2.png" width=75% height=75%>
</div>
...
- Authentication
<div align="center">
    <img src="images/mysqlsink-3.png" width=75% height=75%>
</div>
...
| Setting                | Value                              |
|------------------------|------------------------------------|
| `Topics `              | accounts_to_monitor_{username}            |
...
| `SSL Mode`             | Prefer                             |
| `Tasks`                | 1                                  |
| `Name`                 | MYSQLSink_accounts_to_monitor      |
...
<div align="center">
    <img src="images/mysqlsink-5.png" width=75% height=75%>
</div>
...
6. Switch to the connector metric section and wait for the metrics to populate.

7. Display the new tables created for every user and the data populated in those tables.
***
